...
def main() -> None:
    ...
    if git_blob(train_raw) != train["oid"]:
    ...
    Path("training-metadata.json").write_text(json.dumps(summary, indent=2), encoding="utf-8")
