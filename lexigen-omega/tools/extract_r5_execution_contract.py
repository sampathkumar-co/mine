...
def main() -> None:
    ...
    if FORBIDDEN_COLUMNS.intersection(record):
        raise RuntimeError("forbidden expert metadata entered R5 projector")
    ...
    payload = {
        ...
        "stage": "omega3_R5_execution_contract_after_candidate_prediction_scorer_freeze",
        ...
        "candidate_bytes_frozen_before_contract": True,
        "candidate_timing_accessed_before_contract": False,
        "candidate_outcome_accessed_before_contract": False,
        "claim_boundary": "Execution/performance contract projected only after all R5 candidate patch bytes, exact-sequence prediction, thresholds and scorer were frozen."
    }
