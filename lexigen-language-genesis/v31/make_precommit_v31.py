...
def main() -> None:
    ...
    precommit = {
        ...
        "demonstration_gate": {
            ...
            "seed_rule": "uint32(first_16_hex(sha256(lexigen-v31-demonstration:<task_id>:<attempt_index>)))",
        ...
        "immediate_fresh_gate": {
            ...
            "seed_rule": "uint32(first_16_hex(sha256(lexigen-v31-fresh:<task_id>:<case_index>)))",
