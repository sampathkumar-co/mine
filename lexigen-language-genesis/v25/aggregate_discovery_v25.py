...
def main() -> None:
    ...
    precommit_path = HERE / "V25_PRECOMMIT.json"
    ...
    for path in sorted(args.reports_root.rglob("*.json")):
        report = load(path)
        if report.get("schema") != "lexigen-v25-task-scan-v1":
            continue
    ...
    for task_id in expected_ids:
        ...
        summary.update({
            ...
            "total_unique_expressions": enumeration["total_unique_expressions"],
    ...
    for structure_hash in sorted(structure_index):
        ...
        document = {
            "schema": "lexigen-v25-factorized-structure-v1",
    ...
    library = {
        "schema": "lexigen-v25-factorized-library-v1",
    ...
    report = {
        "schema": "lexigen-v25-discovery-report-v1",
        "precommit_sha256": sha256_file(precommit_path),
        "discovery_task_count": len(expected_ids),
