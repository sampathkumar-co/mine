...
from enumerator_v26 import enumerate_programs
...
def main() -> None:
    ...
    if len(examples) != int(precommit["examples_per_task"]):
        report = {
            "schema": "lexigen-v26-task-scan-v1",
        ...
        enumeration = enumerate_programs(
            ...
            maximum_unique_per_type_per_depth=int(
                precommit["search"]["maximum_unique_per_type_per_depth"]
            ),
            ...
            grid_beam_per_depth=int(precommit['search']['grid_beam_per_depth']),
        )
        report = {
            "schema": "lexigen-v26-task-scan-v1",
            "task_id": args.task_id,
