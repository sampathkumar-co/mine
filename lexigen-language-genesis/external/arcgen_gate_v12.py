...
V7_ROOT, V8_ROOT, V9_ROOT, V10_ROOT, V11_ROOT, V12_ROOT = (
    ROOT / name for name in ("v7", "v8", "v9", "v10", "v11", "v12")
)
sys.path.insert(0, str(V12_ROOT))

from hierarchical_runtime_v12 import as_grid, canonical_json, execute_program, to_json_grid  # noqa: E402
from hierarchical_synthesizer_v12 import synthesize_hierarchical  # noqa: E402
from portable_runtime_v12 import execute_portable  # noqa: E402

PROTOCOL = "arcgen-gate-v12"
...
def command_solve(args) -> None:
    ...
    baselines = {
        ...
        "v11": _baseline(V11_ROOT, "compositional_synthesizer_v11", "synthesize_pipeline", "program", examples),
    }
    try:
        generated = synthesize_hierarchical(examples)
    except Exception:
        generated = None
    ...
    report: dict[str, Any] = {
        ...
        "v12_hierarchical_program_found": bool(generated and generated.program is not None),
    ...
    if generated and generated.program is not None:
        ...
        portable_predictions = [
            execute_portable(program, item["input"])
            for item in package["test"]
        ]
        portable_agreement = predictions == portable_predictions
        artifact = {
            "schema": "lexigen-v12-sealed-hierarchical-artifact-v1",
            "name": program["name"],
        ...
        artifact_path = args.output_dir / "candidate-hierarchical-program.json"
        ...
        report.update(
            {
                "v12_candidates_tested": generated.candidates_tested,
                "v12_exact_program_count": generated.exact_candidate_count,
