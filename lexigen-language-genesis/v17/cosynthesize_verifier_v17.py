...
from constructive_dsl_v17 import Program, Grid, as_grid, execute, sha256_json
from mutations_v17 import apply_output_mutation, canonical, mutation_manifest
...
def synthesize_contract(
    ...
    examples: list[tuple[Grid, Grid]],
    *,
    constructive_grammar_sha256: str,
    ...
    contract: dict[str, Any] = {
        "schema": "lexigen-v17-verifier-contract-v1",
        "revision": int(revision),
        "program_sha256": sha256_json(program),
        "constructive_grammar_sha256": constructive_grammar_sha256,
