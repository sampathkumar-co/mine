...
SOURCE_SHA256='c81c015833ed76feb13b0b9e630b6fb5b44b83de64fc9e32facffd45c5fb86fb'
...
def main():
    ...
    body={'campaign':'LEXIGEN v6 Applicability-Conditioned Causal Transfer Replication','task_index':8,'task':'max_independent_set_cpsat','family':'combinatorial','stage':'source_screen_r1','source_sha256':sha,'features':list(fp.features),'dependency_calls':list(fp.dependency_calls),'applicable_transfer_templates':app,'campaign_preregistered_applicable_transfer_ids':list(CAMPAIGN_IDS),'arms':arms,'arm_counts':{k:len(v) for k,v in arms.items()},'official_train_manifest_opened':False,'official_test_manifest_opened':False,'official_payloads_opened':0,'public_task_specific_solvers_opened':False}
