...
def download(url: str, destination: Path) -> None:
    ...
    for attempt in range(3):
        try:
            request = urllib.request.Request(url, headers={"User-Agent": "LEXIGEN-v2-train-r2"})
...
def warm_up() -> None:
    problem: Problem = {
        ...
        "plaintext": b"LEXIGEN revision 2 warm-up" * 64,
...
def main() -> None:
    ...
    request = urllib.request.Request(
        ...
        headers={"User-Agent": "LEXIGEN-v2-train-r2"},
    )
    ...
    for index, row in selected:
        ...
        for name in names:
            ...
            print(
                ...
                f"reference={reference_s:.6f}s speedup={speedup:.3f}",
                flush=True,
            )
