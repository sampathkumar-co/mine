...
from candidates_r1b import CANDIDATES_BY_ARM
...
def summarise(rows: list[dict[str, object]], arm: str, candidate: str) -> dict[str, object]:
    ...
    exceptions = sum(
        ...
        and not str(row["failure_reason"]).startswith("nonoptimal_size_")
        and str(row["failure_reason"]) != "not_dominating_or_format"
        for row in selected
    )
    summary = {
        "arm": arm,
...
def main() -> None:
    ...
    report = {
        ...
        "generic_correction_sha256": sha256(TASK_DIR / "candidates_r1b.py"),
        ...
        "synthetic_r1_failure_artifact_id": 9493056654,
        "synthetic_r1b_pass_artifact_id": 9493105059,
        "metadata_artifact_id": 9493141286,
        "train_manifest_name": "min_dominating_set_T100ms_n9_size100_train.jsonl",
        "train_manifest_tree_oid": "bb33f6cc4dcf34e7cb79507a0c2f1bb5b239746f",
        "train_manifest_sha256": "203e66d13ecbf3f50789df42a47857dfe58a1d79135f87c2be6979f90283fbda",
        "expected_test_manifest_name": "min_dominating_set_T100ms_n9_size100_test.jsonl",
        "expected_test_manifest_tree_oid": "57cb1a1c49179acde71427362626763f44395c87",
        "frozen_gate": {
